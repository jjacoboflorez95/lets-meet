...
**Let's Meet** is a personal website designed to introduce myself, my hobbies, and my country, **Colombia**. This project showcases different web development techniques, including **flexbox and CSS grid layouts**. The website includes various sections such as an about me page, a homepage, and pages dedicated to Colombia.

This project was developed as an **individual college assignment**.
